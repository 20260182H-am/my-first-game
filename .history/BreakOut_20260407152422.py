...
# 🔥 공 이미지 로드 (추가된 부분)
BALL_R = 18
ball_img = pygame.image.load("./assets/images/BreakOut_ball.png").convert_alpha()
ball_img = pygame.transform.scale(ball_img, (BALL_R * 2, BALL_R * 2))
...
def main():
    ...
    while True:
        ...
        angle += 5
        rotated_img = pygame.transform.rotate(ball_img, angle)
        rect = rotated_img.get_rect(center=ball.center)
